...
/
begin execute immediate 'drop table last_publication_date'; exception when others then null; end;
/
begin execute immediate 'drop table cancel_import'; exception when others then null; end;
/
