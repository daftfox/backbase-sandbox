...
/***/ (function(module, exports, __webpack_require__) {
	...
	}]).factory(hooksKey, (0, _libBbWidgetExtensionNg2.default)(_defaultHooks2.default)).factory(helpersKey, ['$timeout', _helpers2.default]).controller('IncomeSpendingAnalysisCategoryController', [
	// dependencies to inject
	_libBbEventBusNg.eventBusKey, hooksKey, helpersKey, _modelBbIncomeSpendingAnalysisCategoryNg.modelIncomeSpendingAnalysisCategoryKey, _modelBbTurnoversNg.modelTurnoversKey, _libBbIntentNg.bbIntentKey, _libBbWidgetNg.widgetKey,
	/* into */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function IncomeSpendingAnalysisCategoryController(bus, hooks, helpers, model, turnoversModel, bbIntent, widget) {
	   ...
	   */
	  var intentPreferencesArray = widget.getStringPreference('intents').split(',');
	   ...
	   */
	  var subCategoriesPreference = widget.getBooleanPreference(_constants.SUB_CATEGORIES);
	   ...
	   * @returns {boolean}
	   */
	  var isSubCategories = function isSubCategories() {
	    return subCategoriesPreference;
	  };
	   ...
	   * @returns {Promise.<void>}
	   */
	  var updateAnalysisData = function updateAnalysisData() {
	    return updateAnalysisCategories().then(updateTurnovers).then(setSelectedAnalysisItem(null));
	  };
	   ...
	   * @returns {void}
	   */
	  var loadFirstLevelCategories = function loadFirstLevelCategories() {
	  ...
	  var onProductsSelected = function onProductsSelected() {
	    var pfmIgnore = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
	    ...
	    if (pfmIgnore) {
	      payload[_constants.PRODUCT_CHANGE_PFM_FLAG] = pfmIgnore;
	    }
	   ...
	   * @returns {Promise.<void>}
	   */
	  var onCategorySelected = function onCategorySelected(category) {
	  ...
	  function bindEvents() {
	    ...
	    bus.subscribe(PRODUCTS_SELECTED, function (selection) {
	      if (selection[_constants.PRODUCT_CHANGE_PFM_FLAG]) {
	        return;
	      }
	  ...
	  var initIntent = function initIntent() {
	    ...
	    if (intentPreferencesArray.indexOf(_constants.Intent.UPDATE_ANALYSIS_VIEW) > -1) {
	      /**
	       * @description
	       ...
	       * @inner
	       */
	      bbIntent.handle(_constants.Intent.UPDATE_ANALYSIS_VIEW, function () {
	        updateAnalysisCategories().then(setSelectedAnalysisItem(null));
	      });
	    }
	  ...
	  var initPeriodData = function initPeriodData() {
	    ...
	    $ctrl.intervalDuration = _constants.INTERVAL.MONTH;
	    $ctrl.intervalStartDay = _constants.DEFAULT_START_DAY;
	  };
	  ...
	  var $onInit = function $onInit() {
	    $ctrl.isLoading = true;
	    return updateProductsList().then(initProductSelection).then(initPeriodData).then(initIntent).then(updateAnalysisCategories).then(updateTurnovers).then(bindEvents).then(function () {
	  ...
	  Object.assign($ctrl, {
	    ...
	    loadFirstLevelCategories: loadFirstLevelCategories,
...
/***/ (function(module, exports) {
	 ...
	 * @type {string}
	 */
	var SUB_CATEGORIES = exports.SUB_CATEGORIES = 'subCategories';
	 ...
	 * @type {string}
	 */
	var PRODUCT_CHANGE_PFM_FLAG = exports.PRODUCT_CHANGE_PFM_FLAG = 'pfm.update';
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var processSelectedProducts = function processSelectedProducts(products) {
	  return products;
	};
	 ...
	 * @returns {string}
	 */
	var defaultParentCategory = function defaultParentCategory() {
	  return null;
	};
