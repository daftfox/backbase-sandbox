...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _libBbWidgetExtensionNg = __webpack_require__(31);
	
	var _libBbWidgetExtensionNg2 = _interopRequireDefault(_libBbWidgetExtensionNg);
	
	var _libBbEventBusNg = __webpack_require__(32);
	
	var _libBbEventBusNg2 = _interopRequireDefault(_libBbEventBusNg);
	
	var _libBbWidgetNg = __webpack_require__(33);
	
	var _libBbWidgetNg2 = _interopRequireDefault(_libBbWidgetNg);
	
	var _libBbIntentNg = __webpack_require__(34);
	
	var _libBbIntentNg2 = _interopRequireDefault(_libBbIntentNg);
	
	var _libBbExtensionHelpersNg = __webpack_require__(35);
	
	var _libBbExtensionHelpersNg2 = _interopRequireDefault(_libBbExtensionHelpersNg);
	
	var _modelBbBudgetNg = __webpack_require__(36);
	
	var _modelBbBudgetNg2 = _interopRequireDefault(_modelBbBudgetNg);
	
	var _libBbStateContainerNg = __webpack_require__(37);
	...
	var _service = __webpack_require__(39);
	...
	var _listBudgetsController = __webpack_require__(51);
	
	var _listBudgetsController2 = _interopRequireDefault(_listBudgetsController);
	
	var _budgetFormController = __webpack_require__(52);
	...
	exports.default = function (model, viewModel) {
	  return {
	    ...
	    getCategories: function getCategories() {
	      return model.getCategories().then(viewModel.categories.afterGetCategoriesSuccess, viewModel.categories.afterGetCategoriesError);
	    },
	     ...
	     * @return {Promise}
	     */
	    getPreviousSpendings: function getPreviousSpendings(params) {
	      Object.assign(params, {
	        creditDebitIndicator: _constants.spendingIndicator
	      });
	
	      return model.getSpending(params).then(function (response) {
	        return viewModel.spending.afterGetSpendingSuccess(response.items.map(function (item) {
	          return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.spendingIndicator = exports.successMessages = exports.errorMessages = exports.notificationLevels = undefined;
	 ...
	 */
	var spendingIndicator = exports.spendingIndicator = 'DBIT';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _spending = __webpack_require__(47);
	...
	exports.default = function (vm) {
	  return {
	     ...
	     * @inner
	     */
	    spending: (0, _spending2.default)(vm),
	    /**
	     ...
	     * @inner
	     */
	    categories: (0, _categories2.default)(vm)
	  };
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (vm) {
	  return {
	     ...
	     * @return {void}
	     */
	    afterGetSpendingSuccess: vm.createAction(function (current, spendings) {
	      return Object.assign({}, current, {
	        spendings: spendings
	      });
	    }),
	     ...
	     * @return {ViewState} The new state of the view model
	     */
	    afterGetSpendingError: vm.createAction(function (current, error) {
	      return Object.assign({}, current, {
	        budgetsError: (0, _helpers.makeUIErrorMessage)(error)
	      });
	    })
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (vm) {
	  return {
	     ...
	     * @return {void}
	     */
	    afterGetCategoriesSuccess: vm.createAction(function (current, response) {
	      return Object.assign({}, current, {
	     ...
	     * @return {ViewState} The new state of the view model
	     */
	    afterGetCategoriesError: vm.createAction(function (current, error) {
	      return Object.assign({}, current, {
	        budgetsError: (0, _helpers.makeUIErrorMessage)(error)
	      });
	    })
	...
	exports.default = function (service, router) {
	  return {
	    ...
	    $onInit: function $onInit() {
	      ...
	      service.getCategories().then(function () {
	        if (budgetId) {
