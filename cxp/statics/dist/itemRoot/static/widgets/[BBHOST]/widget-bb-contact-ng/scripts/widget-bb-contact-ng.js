...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _defaultHooks = __webpack_require__(91);
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @returns {Object}
	 */
	var getInitialContactsSearch = function getInitialContactsSearch() {
	  return {
	    data: null,
	    loading: false,
	    error: null,
	...
	function ContactController(model, hooks, bus, Promise, scope, window, widget, bbIntents) {
	  ...
	  var state = {
	    ...
	    pageParams: {
	      get from() {
	        return state.searching ? contactsSearch.params.from : contacts.params.from;
	      },
	      get size() {
	        return state.searching ? contactsSearch.params.size : contacts.params.size;
	      },
	      get query() {
	        return contactsSearch.params.query;
	      },
	      get totalItems() {
	  ...
	  var changePage = function changePage() {
	    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { currentPage: 1 };
	    ...
	    if (state.searching) {
	      promise = search(contactsSearch.params.query, replace, Object.assign({}, contactsSearch.params, requestParameters));
	    } else {
	      promise = load(Object.assign({}, contacts.params, requestParameters));
	    }
