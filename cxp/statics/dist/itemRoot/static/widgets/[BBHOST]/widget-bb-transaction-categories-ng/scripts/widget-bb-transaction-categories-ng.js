...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _libBbEventBusNg = __webpack_require__(20);
	
	var _libBbEventBusNg2 = _interopRequireDefault(_libBbEventBusNg);
	
	var _libBbWidgetExtensionNg = __webpack_require__(21);
	
	var _libBbWidgetExtensionNg2 = _interopRequireDefault(_libBbWidgetExtensionNg);
	
	var _modelBbTransactionCategoriesNg = __webpack_require__(22);
	
	var _modelBbTransactionCategoriesNg2 = _interopRequireDefault(_modelBbTransactionCategoriesNg);
	
	var _libBbIntentNg = __webpack_require__(23);
	...
	var _defaultHooks = __webpack_require__(26);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function TransactionCategoriesController(bus, hooks, widget, model, bbIntent) {
	  ...
	  var subCategoriesPreference = widget.getBooleanPreference(_constants.PreferencesKeys.SUB_CATEGORIES);
	  /**
	   * @description
	   ...
	   * @type {function}
	   */
	  var createIntentHandler = function createIntentHandler(intent) {
	    return bbIntent.handle(intent, function (passedData, respond) {
	  ...
	  var $onInit = function $onInit() {
	    $ctrl.isLoading = true;
	    var params = {
	      level: subCategoriesPreference ? _constants.QueryLevelParams.ALL : _constants.QueryLevelParams.PARENTS
	    };
	
	    return model.getCategories(params).then(function (loaded) {
	      ...
	      if (intentPreferencesArray.indexOf(_constants.Intent.SHOW_CATEGORIES_HOME) > -1) {
	        createIntentHandler(_constants.Intent.SHOW_CATEGORIES_HOME);
	      } else if (intentPreferencesArray.indexOf(_constants.Intent.SHOW_CATEGORIES_INSIGHTS) > -1) {
	        createIntentHandler(_constants.Intent.SHOW_CATEGORIES_INSIGHTS);
	      }
...
/***/ (function(module, exports) {
	 ...
	 * @type {object}
	 */
	var QueryLevelParams = exports.QueryLevelParams = {
	  ALL: 'ALL',
	  PARENTS: 'PARENTS'
	};
