...
/***/ (function(module, exports, __webpack_require__) {
	...
	var dependencyKeys = exports.dependencyKeys = [_vendorBbUibDropdown2.default, _vendorBbAngularNgAria2.default, _uiBbI18nNg2.default, _uiBbSubstituteErrorNg2.default, _uiBbSortableColumnNg2.default, _uiBbNotificationStripeNg2.default, _uiBbEllipsisTooltipNg2.default, _uiBbPaginatorNg2.default, _uiBbEmptyStateNg2.default, _uiBbModalNg2.default, _uiBbLoadingOverlayNg2.default, _uiBbAccountStatementsFilterNg2.default, _uiBbAccountSelectorNg2.default, _uiBbCheckboxIndeterminateNg2.default]; /**
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * @module ext-bb-account-statements-ng
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            *
	                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * @description
...
/***/ (function(module, exports) {
	...
	/**
	 * Hooks for ext-bb-account-statements-ng
	 * @name Hooks
	 * @type {Object}
	 */
...
/***/ (function(module, exports) {
	...
	var helpers = function helpers(context) {
	  ...
	  /**
	   * @name Helpers#getEmptyMessageTitle
	   *
	   * @description
	   ...
	   * @returns {string}
	   */
	  var getEmptyMessageTitle = function getEmptyMessageTitle($ctrl) {
	    var type = $ctrl.state.isFiltering ? '.filter' : '';
	    return 'message.empty.state.title' + type;
	  };
	
	  /**
	   * @name Helpers#getEmptyMessageSubtitle
	   *
	   * @description
	   ...
	   * @returns {string}
	   */
	  var getEmptyMessageSubtitle = function getEmptyMessageSubtitle($ctrl) {
	    var type = $ctrl.state.isFiltering ? 'filter' : 'list';
	    return 'message.empty.state.subtitle.' + type;
	  };
	   ...
	   * @returns {boolean}
	   */
	  var isEmpty = function isEmpty($ctrl) {
	    return !$ctrl.state.accountStatements.data.length && !$ctrl.state.accountStatements.loading;
	  };
	   ...
	   * @returns {object}
	   */
	  var getGeneralError = function getGeneralError(ctrl) {
	    return ctrl.state.initialError || ctrl.state.accountStatements.error;
	  };
	  ...
	  return {
	    ...
	    getEmptyMessageTitle: getEmptyMessageTitle,
	    getEmptyMessageSubtitle: getEmptyMessageSubtitle,
	    isEmpty: isEmpty,
	    toggleFiltering: toggleFiltering,
	    getGeneralError: getGeneralError,
...
;
//# sourceMappingURL=ext-bb-account-statements-ng.js.map