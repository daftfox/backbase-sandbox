...
/***/ (function(module, exports) {
	...
	exports.default = function (conf) {
	  return function (httpClient, serializeParams) {
	    ...
	    definedTypes['BudgetingData.Budget-GET'] = { "properties": { "id": { "type": "string", "required": true }, "categoryName": { "type": "string", "required": true }, "budgetName": { "type": "string", "required": true }, "budgetIcon": { "type": "string", "required": false }, "spendingLimit": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": true }, "frequency": { "type": "string", "enum": ["MONTHLY", "ONCE"], "required": true }, "spent": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": false }, "spentPercentage": { "type": "number", "required": false }, "available": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": false }, "period": { "type": "object", "properties": { "startDate": { "type": "string", "format": "date-time", "required": true }, "endDate": { "type": "string", "format": "date-time", "required": false } }, "required": true } } };
	
	    definedTypes['BudgetingData.Budget-UPDATE'] = { "properties": { "budgetName": { "type": "string", "minLength": 1, "maxLength": 50, "required": true }, "spendingLimit": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": true } } };
	
	    definedTypes['BudgetingData.Budget-POST'] = { "properties": { "categoryName": { "type": "string", "minLength": 1, "maxLength": 50, "required": true }, "budgetName": { "type": "string", "minLength": 1, "maxLength": 50, "required": true }, "budgetIcon": { "type": "string", "maxLength": 50, "required": false }, "spendingLimit": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": true }, "frequency": { "type": "string", "enum": ["MONTHLY", "ONCE"], "required": true }, "period": { "type": "object", "properties": { "startDate": { "type": "string", "format": "date-time", "required": true }, "endDate": { "type": "string", "format": "date-time", "required": false } }, "required": true } } };
	
	    definedTypes['BudgetingData.Budget-LIST'] = { "type": "array", "items": { "properties": { "id": { "type": "string", "required": true }, "categoryName": { "type": "string", "required": true }, "budgetName": { "type": "string", "required": true }, "budgetIcon": { "type": "string", "required": false }, "spendingLimit": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": true }, "frequency": { "type": "string", "enum": ["MONTHLY", "ONCE"], "required": true }, "spent": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": false }, "spentPercentage": { "type": "number", "required": false }, "available": { "type": "object", "properties": { "amount": { "type": "string", "required": true }, "currencyCode": { "type": "string", "pattern": "^[A-Z]{3}$", "required": true } }, "required": false }, "period": { "type": "object", "properties": { "startDate": { "type": "string", "format": "date-time", "required": true }, "endDate": { "type": "string", "format": "date-time", "required": false } }, "required": true } } } };
	
	    definedTypes['BudgetingData.Budget-NOT-FOUND'] = { "properties": { "message": { "type": "string", "required": true }, "errors": { "type": "array", "items": { "properties": { "message": { "type": "string", "required": false }, "key": { "type": "string", "required": false }, "context": { "type": "object", "properties": {}, "required": false } } }, "required": false } } };
	     ...
	     * @property {String} budgetName Name of the budget
	     * @property {?String} budgetIcon
	     * @property {BudgetingData.Currency} spendingLimit
	     * @property {String} frequency One of "MONTHLY", "ONCE"
	     * @property {BudgetingData.Period} period
	    ...
	    /**
	     * @typedef BudgetingData.BudgetGET
	     * @type {Object}
	     * @property {String} id Primary Key Internal Budget Id
	     * @property {String} categoryName backbase specific category names
	     * @property {String} budgetName Budget name
	    ...
	    /**
	     * @typedef BudgetingData.Period
	     * @type {Object}
	     * @property {String} startDate Custom start date for budget period.
	     * @property {?String} endDate Custom end date for budget period.
	     * @property {?Object} additions Container object for custom API extensions
	     */
	     ...
	     * @returns {Promise.<Response>} Resolves data value as {@link BudgetingData.BudgetId} on success 
	     *
	     * @example
	     * budgetingData
	     ...
	     * @type {Function}
	     * @description Retrieve list of budgets for the current user
	     ...
	     * @returns {Promise.<Response>} Resolves data value as {@link BudgetingData.Budget-LIST} on success 
	     *
	     * @example
	     * budgetingData
	     ...
	     * @returns {Promise.<Response>} Resolves data value as void on success or rejects with data of {@link BudgetingData.Budget-NOT-FOUND} on error
	     *
	     * @example
	     * budgetingData
