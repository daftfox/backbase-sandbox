...
/***/ (function(module, exports) {
	...
	exports.default = function (conf) {
	  return function (httpClient, serializeParams) {
	     ...
	     * @param {?string} params.query The generic search term to search for contacts either by their name or alias or by one characteristic of their accounts (name, alias, accountNumber or IBAN). Eg: john.
	    ...
	    /**
	     * @name ContactData#getIbanRestrictionsCountries
	     * @type {Function}
	     * @description Retrieve list of all restrictions.
	    ...
	    /**
	     * @name ContactData#getIbanRestrictionsCountriesRecord
	     * @type {Function}
	     * @description Retrieve IBAN length of a country.
