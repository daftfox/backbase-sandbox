...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _uiBbFormatAmountNg = __webpack_require__(5);
	...
	var dependencyKeys = exports.dependencyKeys = [_vendorBbAngularNgAria2.default, _uiBbLoadingIndicatorNg2.default, _uiBbModalNg2.default, _uiBbFormatAmountNg2.default, _uiBbI18nNg2.default]; /**
...
/***/ (function(module, exports) {
	...
	var addChildWithParentName = function addChildWithParentName(category) {
	  return category.subCategories && category.subCategories.length !== 0 ? category : Object.assign({}, category, {
	    subCategories: [Object.assign({}, category)]
	  });
	};
	...
	* @returns {array}
	*/
	var afterCategoriesLoad = exports.afterCategoriesLoad = function afterCategoriesLoad(categories) {
	  return categories.map(addChildWithParentName);
	};
