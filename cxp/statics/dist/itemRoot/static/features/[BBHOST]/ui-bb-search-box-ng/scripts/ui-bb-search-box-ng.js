...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @property {?String}  inputClasses    String with css-classes for input element
	 * @property {Labels}   Labels          Texts used in component
	 * @property {Number}   maxlength       Maxlength attribute of the input component
	 */
...
/***/ (function(module, exports) {
	...
	function controller(element) {
	  ...
	  var submitSearch = function submitSearch() {
	    // allow to alter default button functionality
	    if (ctrl.config && ctrl.config.submitSearchCustom) {
	      ctrl.submitSearchCustom();
	    } else {
	      if (allowRequest()) {
	  ...
	  var $onChanges = function $onChanges(_ref) {
	    ...
	    if (ngModel && ngModel.currentValue !== ngModel.previousValue) {
	      if (!ngModel.isFirstChange() && ngModel.currentValue) {
