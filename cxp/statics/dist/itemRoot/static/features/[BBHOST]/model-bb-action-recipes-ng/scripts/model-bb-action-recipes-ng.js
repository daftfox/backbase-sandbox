...
})(this, function(__WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_25__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _accountMapper = __webpack_require__(26);
	...
	function actionRecipesModel(actionRecipesData, productSummaryData, $q) {
	  ...
	  function loadRecipes() {
	    ...
	    return actionRecipesData.getActionRecipes(params).then(convertRawData).catch(function (httpErrorResponse) {
	  ...
	  function load(params) {
	    return $q.all([loadSpecifications(), loadAccounts(), loadRecipes(params)]).then(function (res) {
	      return {
