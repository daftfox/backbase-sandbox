...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  ...
	  /**
	   * @name categoryNamesOutOfState
	   *
	   * @type {function}
	   * @description State selector for list of available categories
	   */
	  var categoryNamesOutOfState = stateContainer.createSelector(function (state) {
	  ...
	  var createModelHandlers = function createModelHandlers() {
	    ...
	    return {
	       ...
	       *
	       * @type {function}
	       * @description Handler for frequency property of the model
	       * @param {object} formObj form state object
	       * @returns {string} frequency from the form state or
	       * DefaultFrequency constant defined in the extension
	       */
	      frequency: function frequency(formObj) {
	        return (formObj.frequency || _constants.DefaultFrequency).toUpperCase();
	      },
	  ...
	  return {
	     ...
	     *
	     * @type {function}
	     * @description Returns default budget frequency
	     * @returns {string} default value is "Montly"
	     */
	    get defaultFrequency() {
	      return _constants.DefaultFrequency;
	    },
	    ...
	    get transactionsCategoryNames() {
	      return categoryNamesOutOfState();
	    },
	    ...
	    /**
	     * @name getPreviousSpendings
	     *
	     * @type {function}
	     * @description Prepares request parameters and executes handler
	     * @param {function} handler
	     * Widget's method that will be called to fill the state with spending data for previous period
	     */
	    getPreviousSpendings: function getPreviousSpendings(handler) {
	      if (!_constants.GET_PREVIOUS_SPENDINGS) {
	        return;
	      }
	
	      var periodStartDate = new Date(_constants.DefaultPeriod.startDate);
	      periodStartDate.setMonth(periodStartDate.getMonth() - 1);
	      var periodEndDate = new Date(_constants.DefaultPeriod.endDate);
	     ...
	     *
	     * @type {function}
	     * @description Filters through spendings array and finds spending for a targeted category
	     * @param {object[]} spendings
	     * @param {string} categoryName
	     * @returns {object} Object with amount and currency code
	     */
	    getCategorySpending: function getCategorySpending(spendings, categoryName) {
	      return (spendings.filter(function (item) {
...
/***/ (function(module, exports) {
	 ...
	 *
	 * @type {string}
	 * @description Default budget frequency
	 */
	var DefaultFrequency = exports.DefaultFrequency = 'Monthly';
	...
	/**
	 * @name GET_PREVIOUS_SPENDINGS
	 *
	 * @type {boolean}
	 * @description Flag to enable or disable the retrieval of previous
	 * spendings for selected category
	 */
	var GET_PREVIOUS_SPENDINGS = exports.GET_PREVIOUS_SPENDINGS = false;
