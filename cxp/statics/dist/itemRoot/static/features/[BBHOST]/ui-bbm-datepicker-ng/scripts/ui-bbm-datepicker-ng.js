...
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_164__, __WEBPACK_EXTERNAL_MODULE_166__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _uiBbDateLabelFilterNg = __webpack_require__(164);
	...
	var _component = __webpack_require__(168);
	
	var _component2 = _interopRequireDefault(_component);
	
	var _dateDecorator = __webpack_require__(169);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _libBbmPlugins = __webpack_require__(166);
	...
	function DatepickerController($element, $filter) {
	   ...
	   * @type {function}
	   *
	   * @returns {string} date Selected date
	   * @inner
	   */
	  var getSelectedDate = function getSelectedDate() {
	    return getPluginDateParam(ctrl.ngModel);
	  };
	  ...
	  var getDatepickerParams = function getDatepickerParams() {
	    return {
	      ...
	      selectedDate: getPluginDateParam(ctrl.ngModel) || null
	    };
	  };
	 ...
	 * @property {?string} selectedDate Selected date
	 * @inner
	 */
