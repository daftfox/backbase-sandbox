...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _activityIndicator = __webpack_require__(93);
	
	var _activityIndicator2 = _interopRequireDefault(_activityIndicator);
	
	var _alertDialog = __webpack_require__(95);
	...
	var _dropdownAccounts = __webpack_require__(98);
	
	var _dropdownAccounts2 = _interopRequireDefault(_dropdownAccounts);
	
	var _snackbar = __webpack_require__(99);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function DatePicker() {
	  ...
	  return {
	     ...
	     * @property {string} [options.selectedDate] Selected date accepted by the component. The date
	     *                                           must comply with the format specified by dateFormat
	     *                                           parameter
	     * @return  {Promise}
	     */
	    show: function show(options) {
	      ...
	      return new Promise(function (resolve, reject) {
	        _utils2.default.getMobilePlugin(PLUGIN_NAME).show(resolve, reject, params.dateFormat, params.minDate, params.maxDate, params.selectedDate);
	      });
	    },
