...
/***/ (function(module, exports, __webpack_require__) {
	...
	var dependencyKeys = exports.dependencyKeys = [_vendorBbAngularNgAria2.default, _vendorBbUibButtons2.default, _uiBbI18nNg2.default, _uiBbSubstituteErrorNg2.default, _uiBbFormatAmountNg2.default, _uiBbChartjsChartBarNg2.default, _uiBbEmptyStateNg2.default]; /**
	  ...
	  return {
	    ...
	    chartPlugins: [{
	      beforeUpdate: function beforeUpdate(chartInstance) {
	        ...
	        var legendEl = chartInstance.canvas.parentNode.getElementsByClassName(_constants.CSS_SELECTORS.legend);
	    ...
	    customizeTooltip: function customizeTooltip(tooltip, element, data, chart) {
	      ...
	      var defaultClasses = 'chart-tooltip chart-tooltip-wide chart-tooltip-default bb-arrow-bottom';
