...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 *
	 * @name MAX_UNREAD_COUNTER
	 * @enum {number}
	 */
	var MAX_UNREAD_COUNTER = 99;
	...
	exports.default = function (_ref) {
	  ...
	  /**
	   * @name getUnreadCounter
	   * @type {function}
	   *
	   * @description
	   * Helper to get unread counter label
	   *
	   * @param {number} counter Unread counter
	   *
	   * @returns {string} unread counter label
	   */
	  var getUnreadCounter = function getUnreadCounter(counter) {
	    return counter > MAX_UNREAD_COUNTER ? MAX_UNREAD_COUNTER + '+' : counter;
	  };
