...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _directive = __webpack_require__(74);
	 ...
	 *
	 */
	exports.default = _vendorBbAngular2.default.module('ui-bb-focus-ng', []).directive('uiBbFocusNg', ['$timeout', _directive2.default]).name;
	...
	var directive = function directive($timeout) {
	  return {
	    ...
	    link: function link(scope, element, attrs) {
	      scope.$watch(attrs.uiBbFocusNg, function (newValue) {
	        if (newValue) {
	          $timeout(function () {
