(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("mock.data-bb-cxp-authentication-http-ng", ["vendor-bb-angular"], factory);
	else if(typeof exports === 'object')
		exports["mock.data-bb-cxp-authentication-http-ng"] = factory(require("vendor-bb-angular"));
	else
		root["mock.data-bb-cxp-authentication-http-ng"] = factory(root["vendor-bb-angular"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dataBbCxpAuthenticationHttp = __webpack_require__(40);
...
/***/ (function(module, exports) {
	...
	exports.default = function (conf) {
	  return function (httpClient) {
	     ...
	     * @param {object} obj.customParams Object holds extra params key/value pairs
	    ...
	    function buildQueryString(obj) {
	      ...
	      var customParamsKeys = Object.keys(obj.customParams);
	      var customParams = '';
	
	      if (customParamsKeys.length) {
	        customParamsKeys.forEach(function (key) {
	          customParams += key + '=' + obj.customParams[key];
	        });
	        customParams = '&' + customParams;
	      }
	
	      return loginParam + '&' + passwordParam + customParams;
	    }
...
;
//# sourceMappingURL=mock.data-bb-cxp-authentication-http-ng.js.map