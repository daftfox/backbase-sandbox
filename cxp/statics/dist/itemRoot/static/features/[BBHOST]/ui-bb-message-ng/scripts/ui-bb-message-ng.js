...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _directive = __webpack_require__(50);
	 ...
	 * @type {string}
	 */
	exports.default = _vendorBbAngular2.default.module('ui-bb-message-ng', []).directive('uiBbMessageNg', ['$compile', '$window', '$timeout', _directive2.default]).controller('uiBbMessageController', ['$scope', _controller2.default]).name; /**
...
/***/ (function(module, exports) {
	...
	var prepareElement = function prepareElement(elem, linesLength, $window) {
	  ...
	  if (!!linesLength) {
	    ...
	    elem.addClass(isMultiline ? 'multiline-ellipsis' : 'text-truncate d-block').css('height', isMultiline ? linesLength * lineHeight + 'px' : 'auto');
	  }
...
/***/ (function(module, exports) {
	...
	var uiBbMessageController = function uiBbMessageController($scope) {
	  ...
	  /**
	   * @description
	   * Call `onLinkClick` event that define in `ui-bb-message-ng` directive if it is set and prevent
