...
/***/ (function(module, exports, __webpack_require__) {
	...
	function analysisCategoryModel(Promise, transactionsData, productSummaryData, bbStorage, widgetInstance) {
	  /**
	  ...
	  var validateAnalysisParameters = function validateAnalysisParameters(params) {
	    if (params.creditDebitIndicator && Array.isArray(params.arrangementIds) && params.arrangementIds.length && params.periodStartDate && params.periodEndDate) {
