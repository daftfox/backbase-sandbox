...
/***/ (function(module, exports) {
	...
	var component = {
	  ...
	  transclude: true,
	  template: '\n    <div class="row">\n      <div class="col-12 text-center" data-ng-show="$ctrl.isEmpty">\n        <i class="{{$ctrl.iconClasses || \'fa fa-4x fa-bar-chart text-muted\' }} m-4 empty-state-icon"\n          aria-hidden="true"\n        ></i>\n        <p class="empty-state-title"\n          data-role="empty-state-title">\n          <strong>{{ $ctrl.title }}</strong></p>\n        <p class="empty-state-subtitle text-muted mb-5"\n          data-role="empty-state-subtitle"\n          data-ng-bind-html="$ctrl.subtitle"></p>\n      </div>\n    </div>\n\n    <ng-transclude data-ng-hide="$ctrl.isEmpty"></ng-transclude>\n  '
	};
