(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("lib-bb-email", [], factory);
	else if(typeof exports === 'object')
		exports["lib-bb-email"] = factory();
	else
		root["lib-bb-email"] = factory();
})(this, function() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _topLevelDomains = __webpack_require__(63);
	
	var _topLevelDomains2 = _interopRequireDefault(_topLevelDomains);
	...
	exports.default = function (email) {
	  ...
	  if (!_constants2.default.test(String(email).toLowerCase())) {
	    return false;
	  }
	
	  try {
	    return Boolean((0, _topLevelDomains2.default)(email));
	  } catch (error) {
	    return false;
	  }
	};
...
/***/ (function(module, exports) {
	 ...
	 * @type {Object}
	 */
	exports.default = /^[a-zA-Z0-9_+&*-]+(?:\.[a-zA-Z0-9_+&*-]+)*@(?:[a-zA-Z0-9-]+\.)+[a-zA-Z]{2,7}$/;
...
/***/ (function(module, exports) {
	...
	// Reference:
	// https://github.com/apache/commons-validator/blob/trunk/src/main/java/org/apache/commons/validator/routines/DomainValidator.java
	
	/**
	 * Collection of top leevel domains that are maintained by the
	 * Internet Assigned Numbers Authority (IANA) at the Root Zone Database
	 *
	 * @inner
	 * @type {object}
	 */
	...
	'lat', // lat ECOM-LAC Federación de Latinoamérica y el Caribe para Internet
	...
	'moscow', // moscow Foundation for Assistance for Internet Technologies
	...
	'nyc', // nyc The City of New York by and through the New York City Department
	...
	'tatar', // tatar Limited Liability Company Coordination Center of Regional Domain of Tatarstan
	...
	/**
	 * Given an email returns top level domain
	 *
	 * @type {function}
	 * @inner
	...
	exports.default = function (email) {
	  var domainCode = email.substring(email.lastIndexOf('.') + 1);
	  var topLevelDomains = [].concat(infrastructureTLDs, genericTLDs, countryCodeTLDs);
	
	  return topLevelDomains.find(function (item) {
...
;
//# sourceMappingURL=lib-bb-email.js.map