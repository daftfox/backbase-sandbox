...
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_37__) {
...
/***/ (function(module, exports) {
	...
	function loginModel(Promise, cxpData) {
	   ...
	   * @param {object} customParams Key/value pairs of additional params passed to the data module
	   * @returns {Promise}
	   */
	  var login = function login(username, password, customParams) {
	    return cxpData.postLogin({ username: username, password: password, customParams: customParams });
	  };
