...
/***/ (function(module, exports) {
	...
	exports.default = function (conf) {
	  return function (httpClient, serializeParams) {
	    ...
	    definedTypes['NotificationsData.Notifications'] = { "type": "array", "items": { "properties": { "id": { "type": "string", "minLength": 1, "required": true }, "title": { "type": "string", "required": false }, "message": { "type": "string", "minLength": 1, "required": true }, "level": { "type": "string", "enum": ["ALERT", "WARNING", "SUCCESS", "INFO"], "required": true }, "createdOn": { "type": "string", "format": "date-time", "required": true }, "link": { "type": "string", "maxLength": 512, "required": false }, "validFrom": { "type": "string", "format": "date-time", "required": false }, "expiresOn": { "type": "string", "format": "date-time", "required": false }, "read": { "type": "boolean", "required": true }, "origin": { "type": "string", "minLength": 1, "maxLength": 200, "required": true } } } };
	     ...
	     * @returns {Promise.<Response>} Resolves data value as {@link NotificationsData.Notifications} on success  or rejects with data of {@link NotificationsData.Forbidden} on error
	     *
	     * @example
	     * notificationsData
	     ...
	     * @returns {Promise.<Response>} Resolves data value as {@link NotificationsData.CreatedNotifications} on success  or rejects with data of {@link NotificationsData.Forbidden}, {@link NotificationsData.UnprocessableEntity} on error
	     *
	     * @example
	     * notificationsData
	     ...
	     * @returns {Promise.<Response>} Resolves data value as {@link NotificationsData.UnreadNotificationsCount} on success  or rejects with data of {@link NotificationsData.Forbidden} on error
	     *
	     * @example
	     * notificationsData
	     ...
	     * @returns {Promise.<Response>} Resolves data value as {@link NotificationsData.NotificationsStream} on success  or rejects with data of {@link NotificationsData.Forbidden} on error
	     *
	     * @example
	     * notificationsData
	     ...
	     * @returns {Promise.<Response>} Resolves data value as void on success or rejects with data of {@link NotificationsData.Forbidden}, {@link NotificationsData.NotFound} on error
	     *
	     * @example
	     * notificationsData
	     ...
	     * @returns {Promise.<Response>} Resolves data value as void on success or rejects with data of {@link NotificationsData.Forbidden}, {@link NotificationsData.NotFound}, {@link NotificationsData.UnprocessableEntity} on error
	     *
	     * @example
	     * notificationsData
