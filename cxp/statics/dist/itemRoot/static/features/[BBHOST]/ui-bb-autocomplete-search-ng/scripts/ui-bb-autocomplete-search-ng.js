...
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_15__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vendorBbUibTypeahead = __webpack_require__(15);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function uiBbAutocompleteSearchController(element, templateCache, timeout, Promise, document) {
	  ...
	  // Keep track of the latest call of requestResult
	  var requestIterationCounter = 0;
	  ...
	  var state = {
	    ...
	    searchBox: Object.assign({}, defaultSearchBoxConfig)
	  };
	  ...
	  var updateResultModelValue = function updateResultModelValue(searchValue) {
	    var typeaheadNgModelCtrl = typeahead.controller('ngModel');
	
	    // Selecting an option could result in a template change. Check typeahead exists before updating
	    if (typeaheadNgModelCtrl) {
	      typeaheadNgModelCtrl.$setViewValue(searchValue);
	    }
	  };
	  ...
	  var requestResult = function requestResult(options) {
	    requestIterationCounter++;
	    var thisRequestIteration = requestIterationCounter;
	    ...
	    return ctrl.loadResult({ options: options }).then(function (result) {
	      if (requestIterationCounter === thisRequestIteration) {
	  ...
	  /**
	   * @name uiBbAutocompleteSearchController#showEmptyMessage
	   *
	   * @description
	  ...
	  var expandResultScope = function expandResultScope() {
	    ...
	    var list = listWrapper.find('ui-bb-list-ng');
	  ...
	  /**
	   * @name uiBbAutocompleteSearchController#handleClickKeyup
	   *
	   * @description
	   * Handle click & keyup events, decide whether to reset the result and whether to prevent a search
	   *
	   * @inner
	   * @type {Function}
	   * @param {Object} event Event object
	   */
	  var handleClickKeyup = function handleClickKeyup(event) {
	  ...
	  var $onInit = function $onInit() {
	    state.searchBox = Object.assign(state.searchBox, ctrl.searchBoxConfig);
	
	    if (parseInt(ctrl.searchMinLength, 10)) {
	      Object.assign(state, {
	        search: {
	          minLength: ctrl.searchMinLength
	        }
	      });
	    }
	    ...
	    document.on('click keyup', handleClickKeyup);
	  };
	
	  /**
	   * @name uiBbAutocompleteSearchController#$onDestroy
	   *
	   * @description
	  ...
	  var $onDestroy = function $onDestroy() {
	    document.off('click keyup', handleClickKeyup);
	  };
