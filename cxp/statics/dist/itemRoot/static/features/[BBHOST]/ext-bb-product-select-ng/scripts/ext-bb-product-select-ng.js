(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("vendor-bb-angular-ng-aria"), require("ui-bb-account-selector-ng"));
	else if(typeof define === 'function' && define.amd)
		define("ext-bb-product-select-ng", ["vendor-bb-angular-ng-aria", "ui-bb-account-selector-ng"], factory);
	else if(typeof exports === 'object')
		exports["ext-bb-product-select-ng"] = factory(require("vendor-bb-angular-ng-aria"), require("ui-bb-account-selector-ng"));
	else
		root["ext-bb-product-select-ng"] = factory(root["vendor-bb-angular-ng-aria"], root["ui-bb-account-selector-ng"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_20__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _productKindView = __webpack_require__(24);
	
	var _productKindView2 = _interopRequireDefault(_productKindView);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var dependencyKeys = exports.dependencyKeys = [_vendorBbAngularNgAria2.default, _uiBbAccountSelectorNg2.default]; /**
...
/***/ (function(module, exports) {
	 ...
	 * @description
	 * Filter products by visibility before displaying them to the user
	 *
	 * @inner
	 * @type {function}
	 * @param {object} kinds The source Product from the API
	 * @returns {array<ProductKindView>}
	 */
	var filterVisibleProducts = function filterVisibleProducts(kinds) {
	  return kinds.map(function (kind) {
	    return Object.assign({}, kind, {
	      products: kind.products.filter(function (product) {
	...
	exports.default = function (kinds) {
	  return filterVisibleProducts(kinds).reduce(function (memo, _ref) {
