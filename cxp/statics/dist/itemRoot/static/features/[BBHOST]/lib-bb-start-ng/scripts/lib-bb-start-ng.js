...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _libBbEventBusNg = __webpack_require__(18);
	...
	var _libBbWidget = __webpack_require__(61);
	
	var _libBbWidget2 = _interopRequireDefault(_libBbWidget);
	
	var _libBbI18nNg = __webpack_require__(62);
	...
	var _configBbLocale = __webpack_require__(63);
	
	var _libBbWidgetExtensionNg = __webpack_require__(20);
	
	var _libBbExtensionHelpersNg = __webpack_require__(64);
	
	var _libBbExtensionHelpersNg2 = _interopRequireDefault(_libBbExtensionHelpersNg);
	
	var _libBbExtensionEventsNg = __webpack_require__(65);
	...
	function start(require, widgetInstance) {
	  ...
	  require(jsModuleNames, function () {
	    ...
	    var storedStatePromise = (0, _libBbStateContainerNg.getInitialState)(widget);
	    ...
	    var eventBus = (0, _libBbEventBus2.default)(widgetInstance);
	    ...
	    Promise.all([widgetModulePromise, storedStatePromise]).then(function (_ref3) {
	      ...
	      var initWidgetFn = function initWidgetFn() {
	        // Bootstrap Angular with the Angular App
	        _vendorBbAngular2.default.bootstrap(widgetInstance.body, [appModuleKey], { strictDi: true });
	      };
	
	      var INIT_WIDGET_ON_EVENT_PREFERENCE = 'initWidgetOnEvent';
	
	      var eventInitWidgetOn = widget.getStringPreference(INIT_WIDGET_ON_EVENT_PREFERENCE);
	
	      if (eventInitWidgetOn) {
	        var unsubscribe = eventBus.subscribe(eventInitWidgetOn, function () {
	          initWidgetFn();
	          unsubscribe();
	        });
	      } else {
